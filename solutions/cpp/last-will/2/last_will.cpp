...
namespace estate_executor
{
    ...
    int assemble_code()
    {
        int zhang_red_fragment = zhang::red::code_fragment();
        int khan_red_fragment = khan::red::code_fragment();
        int garcia_red_fragment = garcia::red::code_fragment();

        int zhang_blue_fragment = zhang::blue::code_fragment();
        int khan_blue_fragment = khan::blue::code_fragment();
        int garcia_blue_fragment = garcia::blue::code_fragment();

        int reds = zhang_red_fragment + khan_red_fragment + garcia_red_fragment;
        int blues = zhang_blue_fragment + khan_blue_fragment + garcia_blue_fragment;
